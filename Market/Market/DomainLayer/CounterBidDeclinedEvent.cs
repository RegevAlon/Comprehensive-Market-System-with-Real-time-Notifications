...
{
    public class CounterBidDeclinedEvent : Event
    {
        private Bid _bid;
        private Product _product;
        private Shop _shop;
        public CounterBidDeclinedEvent(Shop shop, Product product, Bid bid) : base("Counter Bid Declined Event")
        {
            _shop = shop;
            _product = product;
            _bid = bid;
        ...
        public override string GenerateMsg()
        {
            return $"{Name}: Shop: \'{_shop.Name}\', Product name: \'{_product.Name}\', " +
                ...
                $"{_bid.SuggestedPrice}, Bidding member: {_bid.BiddingMember.UserName} Declined Bid.";
        }
